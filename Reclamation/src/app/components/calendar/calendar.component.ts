...
import { Query, Predicate, DataManager, UrlAdaptor  } from '@syncfusion/ej2-data';
...
import {
  ...
  TimelineMonthService, ResizeService, DragAndDropService, EventSettingsModel,
...
import {ActionEventArgs} from '@syncfusion/ej2-angular-grids';
...
export class CalendarComponent implements OnInit {
  ...
  @ViewChild('scheduleObj') scheduleComponent: ScheduleComponent;
  ...
  public eventSettingsModel: EventSettingsModel = { dataSource: this.dataManager };
  private scheduleObj: any;

  public ngOnInit(): void {
    //this.scheduleObj.timeFormat = "yyyy-mm-ddThh:mm:ss.s";
  ...
  public onActionBegin(args: ActionEventArgs): void {
    ...
    if (args.requestType === 'eventCreate' || args.requestType === 'eventChange') {
      ...
      const data: Record<string, any> = (args.requestType === 'eventCreate' ? (args.data as Record<string, any>[])[0] :(args.requestType as Record<string, any>[])[0]);
  ...
  public onTreeDragStop(event: DragAndDropEventArgs): void {
    ...
    const tooltipElement: HTMLElement | null = document.querySelector('.e-drag-item.e-treeview');
